SELECT * FROM StrutturaRicettiva
 WHERE codiceStruttura NOT IN (
    ...
    GROUP BY Prenotazione.Ostello, postiLettoTotali, prezzoNottePostoLetto
    HAVING SUM(numeroOspiti) >= Ostello.postiLettoTotali OR prezzoNottePostoLetto > 50
   ...
   OR codiceStruttura IN (
    ...
    WHERE codiceTipologia NOT IN (
        ...
        WHERE StanzeTotaliPrenotate >= TipoStanza.stanzePerTipologia OR prezzoNotte > 50
    )
